...
class ImageSelectEditar extends StatefulWidget {
  @override
  _ImageSelectEditarState createState() => _ImageSelectEditarState();
}

class _ImageSelectEditarState extends State<ImageSelectEditar> {
